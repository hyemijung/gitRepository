...
public class CarTest1_1_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("fe의 주소: " +  fe);
		System.out.println("car의 주소(car=fe;)형변환 후: " + car);
