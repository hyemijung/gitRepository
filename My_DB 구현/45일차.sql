...
INSERT INTO LICENSE_INFO(SNUMBER,NAME,ADRESS,PHONE,LICENSE,LNUMBER,LDATE)
VALUES (2,'홍길동','하와이','010-111-1111','정보처리',12345,'고3');
...
-- 테이블정보 백업
CREATE TABLE LICENSE_INFO_BACKUP
AS
SELECT *
FROM LICENSE_INFO;
...
-- 커밋하기전에 잘못 입력한 자료는 ROLLBACK; 으로 되돌릴수있다
...
INSERT INTO LICENSE_INFO(SNUMBER,NAME,ADRESS,PHONE,LICENSE,LNUMBER,LDATE)
VALUES (3,'김개똥','아일랜드','010-222-222','정보처리',12345,'대4');


INSERT INTO LICENSE_INFO(SNUMBER,NAME,ADRESS,PHONE,LICENSE,LNUMBER,LDATE)
VALUES (4,'김개똥','하와이','010-333-3333','정보처리',12345,'고2');
...
INSERT INTO student(SNUMBER,NAME,ADRESS,PHONE)
VALUES (1,'김개똥','하와이','010-9999-9999');

INSERT INTO student(SNUMBER,NAME,ADRESS,PHONE)
VALUES (2,'홍길동','하와이','010-111-1111');

INSERT INTO student(SNUMBER,NAME,ADRESS,PHONE)
VALUES (3,'김개똥','아일랜드','010-222-222');

INSERT INTO student(SNUMBER,NAME,ADRESS,PHONE)
VALUES (4,'김개똥','하와이','010-333-333');




create table license(
num_license number(5) primary key,
license     varchar2(20),
lnumber    number(5),
ldate         varchar2(20),
snumber    number(2) 
...
alter table license
add constraint license_snumber foreign key(snumber)
...
INSERT INTO license(num_license,license,lnumber,ldate,SNUMBER)
VALUES (1,'정보처리',12345,'대4', 1);

INSERT INTO license(num_license,license,lnumber,ldate,SNUMBER)
VALUES (2,'워드1급',23456,'고2', 1);

INSERT INTO license(num_license,license,lnumber,ldate,SNUMBER)
VALUES (3,'SQLD',34567,'고3', 1);

INSERT INTO license(num_license,license,lnumber,ldate,SNUMBER)
VALUES (4,'TOEIC',45678,'고3', 1);
